...
namespace AppBindingCommands.ViewModels
{
    public class UsuarioViewModel : INotifyPropertyChanged
    {
        ...
        {
            if (await Application.Current
                .MainPage.DisplayAlert("Confirmação", "Confirma limpeza dos dados", "Yes", "No"))
            {
                Name = string.Empty;
                ...
                await Application.Current
                    .MainPage.DisplayAlert("Confirmação", "Limpeza realizada com sucesso.", "Ok");
            }
        }
